    ...
    private void ellipsize() {
        linkifyCommentContentView(v -> {
            ...
            if (itemContentView.getLineCount() > COMMENT_DEFAULT_LINES) {
                ...
                int end = layout.getLineEnd(COMMENT_DEFAULT_LINES - 1);
                if (layout.getLineWidth(COMMENT_DEFAULT_LINES - 1) + ellipsisWidthPx
                        > layout.getWidth()) {
                ...
                final String newVal = itemContentView.getText().subSequence(0, end) + ELLIPSIS;
